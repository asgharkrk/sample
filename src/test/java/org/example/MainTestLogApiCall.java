...
public class MainTestLogApiCall {
    ...
    private static final String PAYLOAD_FILE_PATH = "src/test/java/org/example/payload.json";
    ...
    public static void main(String[] args) {
        try {
            ...
            // Convert the updated JSON payload back to a String
            String updatedPayload = payloadJson.toString(4); // pretty-print with indent of 4 spaces
